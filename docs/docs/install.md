...
| --- | --- | --- | --- |
| `@qorechain/rdk` | TypeScript | `npm i @qorechain/rdk` | Available (v0.4.4) |
| `@qorechain/rdk-cli` (`qorollup`) | CLI | `npm i -g @qorechain/rdk-cli` | Available (v0.4.4) |
| `qorechain-rdk` | Python | `pip install qorechain-rdk` (imports as `qorrdk`) | Available on PyPI (v0.4.4) |
| `qorechain-rdk` | Go | `go get github.com/qorechain/qorechain-rdk/packages/go` | Available (v0.4.4) |
| `qorechain-rdk` | Rust | `cargo add qorechain-rdk` | Available on crates.io (v0.4.4) |
| `io.github.qorechain:qorechain-rdk` | Java (JVM) | Maven/Gradle (`io.github.qorechain:qorechain-rdk:0.4.4`) | Available on Maven Central (v0.4.4) |
| `create-qorechain-rollup` | CLI | `npm create qorechain-rollup` | Available (v0.4.4) |
...
```kotlin
implementation("io.github.qorechain:qorechain-rdk:0.4.4")
```
