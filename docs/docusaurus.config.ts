...
const config: Config = {
  title: "QoreChain RDK",
  tagline: "Launch app-specific rollups on QoreChain — a quantum-safe Layer 1",
  favicon: "img/favicon.ico",

  url: "https://qorechain.github.io",
  baseUrl: "/qorechain-rdk/",

  organizationName: "qorechain",
  projectName: "qorechain-rdk",
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl:
            "https://github.com/qorechain/qorechain-rdk/tree/main/docs/",
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://github.com/qorechain/qorechain-rdk",
          label: "GitHub",
          position: "right",
        },
      ],
